...
export default function CourseCardSkeleton() {
  return (
    <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-black/5 dark:border-white/10 overflow-hidden animate-pulse">
      {/* Thumbnail */}
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="h-10 bg-neutral-200 dark:bg-neutral-700 rounded-xl" />
      </div>
    </div>
  );
}
