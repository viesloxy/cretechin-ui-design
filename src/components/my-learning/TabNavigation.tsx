...
const tabs = [
  { label: "Masih Dipelajari", value: "in-progress" as TabType, icon: BookOpen },
  { label: "Sudah Lulus", value: "completed" as TabType, icon: CheckCircle },
];
          ...
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                {inProgressCount !== undefined && inProgressCount > 0 && isActive && (
