  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 py-3 border-t border-neutral-100 dark:border-neutral-800">
      <p className="text-xs text-neutral-500 dark:text-neutral-400">
        ...
        <span className="font-semibold text-neutral-700 dark:text-neutral-300">{totalItems}</span> artikel
      </p>
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-1">
          ...
          {pages.map((p, i) =>
            p === "…" ? (
              <span key={`ellipsis-${i}`} className="px-1 text-neutral-400 text-xs">
                …
              </span>
            ) : (
              <button
